...
const configureSuccessfulPairing = (
  ...
  const { details, hmac, accountType } =
    WAProto_1.proto.ADVSignedDeviceIdentityHMAC.decode(
  ...
  if (
    ...
    accountType === WAProto_1.proto.ADVEncryptionType.HOSTED
  ) {
  ...
  const deviceIdentity =
    WAProto_1.proto.ADVDeviceIdentity.decode(deviceDetails);
