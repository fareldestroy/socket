...
const extractGroupMetadata = (result) => {
  ...
  const metadata = {
    ...
    subjectOwner: WABinary_1.jidNormalizedUser(
      group.attrs.s_o_pn || group.attrs.s_o,
    ),
    ...
    size:
      groupSize ||
      WABinary_1.getBinaryNodeChildren(group, "participant").length,
    creation: group.attrs.creation ? +group.attrs.creation : undefined,
    owner: WABinary_1.jidNormalizedUser(
      group.attrs.creator_pn || group.attrs.creator,
    ),
    ...(group.attrs.addressing_mode === "lid"
